...
See demo of this plugin: [medium-editor-insert-plugin | example](http://orthes.github.io/medium-editor-insert-plugin)
...
4) Once ready to be updated, bump up the version number in package.json, git tag --[VERSION_NUMBER], git push --tags
5) Update the version number in gumroad/web's package.json
...
2.5.5 -- initial updates for Gumroad's implementation of inline images